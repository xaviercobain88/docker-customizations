...
# Add the datasource
data-source add --name=mysqlDS --driver-name=mysql --jndi-name=java:jboss/datasources/restServicesDS --connection-url=jdbc:mysql://$MYSQL_HOST:$MYSQL_PORT/great_final_dev_db?useUnicode=true&amp;characterEncoding=UTF-8 --user-name=root --password=axre125423 --use-ccm=false --max-pool-size=25 --blocking-timeout-wait-millis=5000 --enabled=true
